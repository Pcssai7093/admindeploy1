...
function Services({ menu_name }) {
  ...
  useEffect(() => {
    axios
      .get("https://fsd-backend.glitch.me/admin/services")
      .then((result) => {
  ...
  async function handleBlockChange(sid, currentStatus) {
    ...
    console.log(data);
    await axios
      .post("https://fsd-backend.glitch.me/service/blockHandle", data)
      .then((response) => {
  ...
  async function handleFilter() {
    ...
    await axios
      .post("https://fsd-backend.glitch.me/admin/service/filter", filter)
      .then((result) => {
